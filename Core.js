...
Typed *surrender* to surrender and admited defeat`
  ...
  if (smallinput=='runtime') {
    reply (`Hi💞 ${pushname}©ʍɾ ℂ𝕪𝕓𝕖𝕣 ʍɑղմӀ օƒƒíϲíɑӀ♠${runtime(process.uptime())}\n\nCurrent Time: ${kaitime}\n\nCurrent Date: ${kaidate}`)
  }
  ...
  if (smallinput.includes('good afternoon') || smallinput.includes('konnichiwa')) {
    ...
    reply (`Good afthernoon to you too ${pushname} ©ʍɾ ℂ𝕪𝕓𝕖𝕣 ʍɑղմӀ օƒƒíϲíɑӀ♠.`);
  
  }
  
  
  //if (smallinput.includes('good afthernoon')) {
   // reply (`Huh ${pushname} 😇.©ʍɾ ℂ𝕪𝕓𝕖𝕣 ʍɑղմӀ օƒƒíϲíɑӀ♠`);
  //   }
        ...
        let buttonMessage = {
          ...
          contextInfo: {
            externalAdreply: {
              ...
              mediaUrl: 'github.com/manulofficial7/Manul-Official-Whatsapp-Bot',
              sourceUrl: "github.com/manulofficial7/Manul-Official-Whatsapp-Bot"
            }
          }
  ...
  *Response Speed*: ${latensie.toFixed(4)} seconds
  ...
  👉 Following : ${gitdata.following}`
      ...
      case 'git-clone':
        ...
        if (!args[0]) {
          return reply(`Please provide the GitHub repository link.\nExample:\n${prefix}${command} https://github.com/manulofficial7/Manul-Official-Whatsapp-Bot
©ʍɾ ℂ𝕪𝕓𝕖𝕣 ʍɑղմӀ օƒƒíϲíɑӀ♠
          `);
        }
      ...
      case 'listgc': {
        ...
        let teks = ` 「  ©ʍɾ ℂ𝕪𝕓𝕖𝕣 ʍɑղմӀ օƒƒíϲíɑӀ♠ group user list  」\n\nTotal ${anu.length} users are using bot in Groups.`
        for (let i of anu) {
...
*Message : ${args.join(" ") ? args.join(" ") : 'no message'}*\n\n`
      ...
      case 'hidetag': case 'tag': case 'ooo': {
        ...
        if (!isAdmins && !isCreator) return reply(mess.useradmin)
        A17.sendMessage(from, { react: { text: "💬", key: m.key } })
        A17.sendMessage(m.chat, { text: args.join("©ʍɾ ℂ𝕪𝕓𝕖𝕣 ʍɑղմӀ օƒƒíϲíɑӀ♠") ? args.join("©ʍɾ ℂ𝕪𝕓𝕖𝕣 ʍɑղմӀ օƒƒíϲíɑӀ♠") : '', mentions: participants.map(a => a.id) }, { quoted: m })
      }
        break;
      ...
      case 'tagadmins': case 'admins': {
        ...
        if (!m.isGroup) return reply(mess.grouponly);
        A17.sendMessage(from, { react: { text: "🗿", key: m.key } })
        if (!text) return reply(`*©ʍɾ ℂ𝕪𝕓𝕖𝕣 ʍɑղմӀ օƒƒíϲíɑӀ♠*`)
        let teks = `*「 Tag Admins 」*
...
└─────────────`,
      ...
      case 'ytvd': case 'video': case 'ytvideo': case 'ytmp4': {
        ...
        A17.sendMessage(from, { video: { url: ytmp4play.videoUrl }, mimetype: "video/mp4", caption: anu.title + '©ʍɾ ℂ𝕪𝕓𝕖𝕣 ʍɑղմӀ օƒƒíϲíɑӀ♠\n*ᴍᴀɴᴜʟ-ᴏꜰꜰɪᴄɪᴀʟ*', }, { quoted: m })
      }
      ...
      */
      ...
      case 'ytmp3': {
        ...
        await A17.sendMessage(from, { document: fs.readFileSync(ytmp3play2.path), fileName: 'CYBER-MANUWA-MD_YTmp3_Downloader.mp3', mimetype: 'audio/mpeg', }, { quoted: m })
      }
        break;
      ...
      case 'ytvd2': case 'ytmp4': {
        ...
        A17.sendMessage(from, { video: { url: ytmp4play2.videoUrl }, mimetype: "video/mp4", caption: '━━━❬❬📍  *©ʍɾ ℂ𝕪𝕓𝕖𝕣 ʍɑղմӀ օƒƒíϲíɑӀ♠* 💖❭❭ ━━━', }, { quoted: m })
      }
        break;
...
❒│▸  *Tɪᴍᴇ : ${kaitime}* ⌚
❒│▸  *Dᴀᴛᴇ : ${kaidate}* 📆
❒│▸  *Oᴡɴᴇʀ : ${global.OwnerName}* ⚖️
❒│▸  *Pʀᴇꜰɪx : 『  ${prefix} 』*  💡
❒│▸  *Rᴜɴᴛɪᴍᴇ : ${runtime(process.uptime())}* 💻
❒│▸  *Dᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ©ʍɾ ℂ𝕪𝕓𝕖𝕣 ʍɑղմӀ օƒƒíϲíɑӀ♠* 
┬│   *ᴄʏʙᴇʀ-ᴍᴀɴᴜ-ᴍᴅ*
│╰───────────···▸▸
└──────────────···▸▸▸
┌──『•• 📍 *ᴍᴇɴᴜ* 💖 ••』──◈
...
{buttonId: `${prefix}qr`, buttonText: {displayText: `Tap to Re-run Repl`}, type: 1}
      ...
      default:
        ...
        if (isCmd) {
          ...
          if (isBanChat) return reply(mess.bangc);
          A17.sendMessage(from, { react: { text: "❌", key: m.key } })
          reply(`Hey *${pushname}* *මෙවනි විදානයක් මා සතුව නැත..*${prefix}*menu* *ලෙස ටයිප් කරන්න. By -: ©ʍɾ ℂ𝕪𝕓𝕖𝕣 ʍɑղմӀ օƒƒíϲíɑӀ♠*.`)
